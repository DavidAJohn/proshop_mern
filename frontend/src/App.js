    ...
    <Router>
      ...
      <main className='py-3'>
        <Container>
          ...
          <Route path='/admin/inactiveproductlist' component={InactiveProductListScreen} exact />
          <Route path='/admin/inactiveproductlist/page/:pageNumber' component={InactiveProductListScreen} exact />
